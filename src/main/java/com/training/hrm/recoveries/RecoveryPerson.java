...
public class RecoveryPerson {
    ...
    public RecoveryPerson(Long recoveryPersonID, Long personID, String fullName, String gender, LocalDate birthOfDate, CitizenIdentity citizenIdentity, PassPort passPort, String permanentAddress, String currentAddress, String phoneNumber, String email) {
        this.recoveryPersonID = recoveryPersonID;
    ...
    public Long getRecoveryPersonID() {
        return recoveryPersonID;
    }

    public void setRecoveryPersonID(Long recoveryPersonID) {
        this.recoveryPersonID = recoveryPersonID;
    }
